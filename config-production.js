// Configuração de produção para o Sistema de Controle de Obras - Maricá
// Este arquivo já contém as credenciais do Supabase configuradas

const CONFIG = {
    // Configurações do Google Maps
    // IMPORTANTE: Substitua pela sua chave do Google Maps API
